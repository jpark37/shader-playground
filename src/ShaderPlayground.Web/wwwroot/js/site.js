        ...
        onCompilerChanged() {
            ...
            for (let parameter of compiler.parameters) {
                ...
                if (parameterEditor.isVersion) {
                    ...
                    if (parameter.filter !== null && parameter.filter !== "__InputLanguage") {
                        var otherParameterEditor = this.parameterEditors.find(x => x.parameter.name === parameter.filter.name);
                        function updateVisibility() {
                            if (otherParameterEditor.value === parameter.filter.value)
