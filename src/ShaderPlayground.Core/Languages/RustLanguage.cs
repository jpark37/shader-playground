...
{
    internal sealed class RustLanguage : IShaderLanguage
    {
        public string Name { get; } = LanguageNames.Rust;

        public string DefaultCode { get; } = DefaultRustCode;

        public string FileExtension { get; } = "rs";

        private static readonly string DefaultRustCode = @"#![cfg_attr(
    target_arch = ""spirv"",
        no_std,
